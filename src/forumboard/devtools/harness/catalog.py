    ...
    plugin = Plugin(
        ...
        hooks=HookSet(
            ...
            allowed_fetch=[
                ...
                # Notion's API reference. This project writes every artifact it
                # produces to Notion, and that API moved to data sources and
                # Markdown page bodies in 2025-09-03 — so answering from memory
                # is how a session writes a payload the workspace rejects.
                HookUrlScope(origin=AnyHttpUrl("https://developers.notion.com")),
                HookUrlScope(origin=AnyHttpUrl("http://developers.notion.com")),
